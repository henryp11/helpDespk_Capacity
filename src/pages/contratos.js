...
const moduleHeaders = {
  ...
  columnTitles: [
    { id: 'col1', name: 'Id.Contrato', show: true },
    { id: 'col2', name: 'Empresa', show: true },
    { id: 'col3', name: 'Plan Adquirido', show: true },
    { id: 'col4', name: 'Fecha inicio', show: true },
    { id: 'col5', name: 'Fecha Finalización', show: true },
  ],
};
                ...
                >
                  ...
                  <span className="icons-container">
                    <button
                      ...
                      onClick={() => {
                        if (open) {
                          if (regCapture !== register.id_contrato) {
                            setOpen(false);
                            setRegCapture(register.id_contrato);
                    ...
                    <Link href={`/contratos/${register.id_contrato}?edit=true`}>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                  ...
                  {regCapture === register.id_contrato && (
                    <ContractDetails open={open} details={dataRegCap} />
                  )}
                </div>
              );
            })}
