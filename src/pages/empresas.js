...
const moduleHeaders = {
  ...
  columnTitles: [
    { id: 'col1', name: 'Id.Emp', show: true },
    { id: 'col2', name: 'Nombre', show: true },
    { id: 'col3', name: 'RUC', show: true },
                ...
                >
                  ...
                  <span className="icons-container">
                    <button
                      ...
                      onClick={() => {
                        if (open) {
                          if (regCapture !== register.id_emp) {
                            setOpen(false);
                            setRegCapture(register.id_emp);
                    ...
                    <Link href={`/empresas/${register.id_emp}?edit=true`}>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                  ...
                  {regCapture === register.id_emp && (
                    <EmpDetails open={open} details={dataRegCap} />
                  )}
                </div>
              );
            })}
