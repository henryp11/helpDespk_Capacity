...
import PerEmpDetails from '../containers/PerEmpDetails';
...
const moduleHeaders = {
  ...
  columnTitles: [
    { id: 'col1', name: 'Doc. Ident.', show: true },
    { id: 'col2', name: 'Empresa', show: true },
    { id: 'col3', name: 'Nombre', show: true },
    { id: 'col4', name: 'Cargo', show: true },
                ...
                >
                  ...
                  <span className="icons-container">
                    <button
                      ...
                      onClick={() => {
                        if (open) {
                          if (regCapture !== register.id_per) {
                            setOpen(false);
                            setRegCapture(register.id_per);
                    ...
                    <Link href={`/personal/${register.id_per}?edit=true`}>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                  ...
                  {regCapture === register.id_per && (
                    <PerEmpDetails open={open} details={dataRegCap} />
                  )}
                </div>
              );
            })}
