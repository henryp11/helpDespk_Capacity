...
const moduleHeaders = {
  ...
  columnTitles: [
    { id: 'col1', name: 'Id.Usuario', show: true },
    { id: 'col2', name: 'Vinculado con', show: true },
    { id: 'col3', name: 'UserName', show: true },
    { id: 'col4', name: 'Email Registro', show: true },
    { id: 'col5', name: 'Rol', show: true },
  ],
};
                ...
                >
                  ...
                  <span className="icons-container">
                    <button
                      ...
                      onClick={() => {
                        if (open) {
                          if (regCapture !== register.id_user) {
                            setOpen(false);
                            setRegCapture(register.id_user);
                    ...
                    <Link href={`/usuarios/${register.id_user}?edit=true`}>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                  ...
                  {regCapture === register.id_user && (
                    <UsersDetails open={open} details={dataRegCap} />
                  )}
                </div>
              );
            })}
